    ...
    function buildTable(container, chamber) {
        ...
        d3.select(container).selectAll(".row")
            ...
            .html(function(d) {
                ...
                if (chamber == "house") {
                    if (d.house_written == "yes") {
                        cell1 = "green3";
                        status1 = "Y";
                    } else if (d.house_written == "no") {
                        cell1 = "orange3";
                        status1 = "N";
                    } else {
                        cell1 = "gray3";
                    ...
                    if (d.house_lawmakers == "yes") {
                        cell3 = "green3";
                        status3 = "Y";
                    } else if (d.house_lawmakers == "no") {
                        cell3 = "orange3";
                        status3 = "N";
                    } else {
                        cell3 = "gray3";
                    ...
                    if (d.house_investigations == "yes") {
                        cell4 = "green3";
                        status4 = "Y";
                    } else if (d.house_investigations == "no") {
                        cell4 = "orange3";
                        status4 = "N";
                    } else {
                        cell4 = "gray3";
                ...
                if (chamber == "senate") {
                    if (d.senate_written == "yes") {
                        cell1 = "green3";
                        status1 = "Y";
                    } else if (d.senate_written == "no") {
                        cell1 = "orange3";
                        status1 = "N";
                    } else {
                        cell1 = "gray3";
                    ...
                    if (d.senate_soon == "yes") {
                        cell2 = "green3";
                        status2 = "Y";
                    } else if (d.senate_soon == "no") {
                        cell2 = "orange3";
                        status2 = "N";
                    } else {
                        cell2 = "gray3";
                    ...
                    if (d.senate_lawmakers == "yes") {
                        cell3 = "green3";
                        status3 = "Y";
                    } else if (d.senate_lawmakers == "no") {
                        cell3 = "orange3";
                        status3 = "N";
                    } else {
                        cell3 = "gray3";
                    ...
                    if (d.senate_investigations == "yes") {
                        cell4 = "green3";
                        status4 = "Y";
                    } else if (d.senate_investigations == "no") {
                        cell4 = "orange3";
                        status4 = "N";
                    } else {
                        cell4 = "gray3";
...
var cartogram2 = {
    ...
    state_pos_co2: [{
        ...
        },
        {
            ...
            'state_total_old': '0',
            'state_total_new': '0',
            'state_change': 'Insufficient data',
            'color': 'orange3'
        },
        {
            'state_full': 'Arizona',
